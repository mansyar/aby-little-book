...
export const validAssetLayers: AssetLayer[] = [
  {
    ...
    role: 'background',
    order: 0,
    src: 'assets/layers/ipad-landscape/bg-space.webp',
    width: 2048,
    height: 1536,
    sha256: 'a'.repeat(64),
  ...
  },
  {
    ...
    role: 'character',
    order: 1,
    src: 'assets/layers/ipad-landscape/char-aby.webp',
    width: 2048,
    height: 1536,
    sha256: 'b'.repeat(64),
    layout: 'ipad-landscape',
  },
  {
    ...
    role: 'effect',
    order: 2,
    src: 'assets/layers/ipad-landscape/fx-glow.webp',
    width: 2048,
    height: 1536,
    sha256: 'c'.repeat(64),
  ...
  },
  {
    ...
    role: 'background',
    order: 0,
    src: 'assets/layers/phone-portrait/bg-space.webp',
    width: 1080,
    height: 1920,
    sha256: 'd'.repeat(64),
  ...
  },
  {
    ...
    role: 'character',
    order: 1,
    src: 'assets/layers/phone-portrait/char-aby.webp',
    width: 1080,
    height: 1920,
    sha256: 'e'.repeat(64),
    layout: 'phone-portrait',
  },
  {
    ...
    role: 'effect',
    order: 2,
    src: 'assets/layers/phone-portrait/fx-glow.webp',
    width: 1080,
    height: 1920,
    sha256: 'f'.repeat(64),
    safeRegion: { x: 0.1, y: 0.2, width: 0.4, height: 0.3 },
